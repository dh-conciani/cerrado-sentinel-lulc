...
var file_in = ee.FeatureCollection('projects/barbaracosta-ipam/assets/collection-9_rocky-outcrop/sample/area/stable_v2');
...
// Define output
var output = 'projects/barbaracosta-ipam/assets/collection-2_rocky_outcrop/sample/points/';

// Define classes to generate samples
var classes = [1, 2, 29];

// Rocky outcrop samples
var rocky_samples = ee.FeatureCollection('projects/barbaracosta-ipam/assets/collection-2_rocky_outcrop/sample/rocky-outcrop-collected')
...
var stablePixels = ee.Image('projects/barbaracosta-ipam/assets/collection-2_rocky_outcrop/masks/cerrado_rockyTrainingMask_2016_2023_v1')
                  .rename('class');
