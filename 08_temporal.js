...
// define the function to calc frequencies m
...
// plot
Map.addLayer(classification.select(['classification_2017']), vis, 'classification');
Map.addLayer(classification_filtered.select(['classification_2017']), vis, 'filtered');
...
Export.image.toAsset({
    ...
    'description': 'CERRADO_sentinel_gapfill_temporal_freq_v' + version_out,
    'assetId': root + 'CERRADO_sentinel_gapfill_temporal_freq_v' + version_out,
    'pyramidingPolicy': {
        '.default': 'mode'
    },
