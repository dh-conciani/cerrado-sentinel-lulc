...
filtered = window3valores(filtered, [11, 19, 19, 12])     // "deforestation" of wetland to mosaic rather than grassland
filtered = window3valores(filtered, [19, 19, 12, 12])     // "deforestation" of grassland to mosaic rather than grassland
filtered = window3valores(filtered, [12, 19, 19, 12])     // "deforestation" of grassland to mosaic rather than grassland
filtered = window3valores(filtered, [3, 12, 15, 15])      // "deforestation" of forest to mosaic rather than grassland
filtered = window3valores(filtered, [3, 12, 12, 15])      // "deforestation" of forest to mosaic rather than grassland
filtered = window3valores(filtered, [4, 12, 15, 15])      // "deforestation" of savanna to mosaic rather than grassland
filtered = window3valores(filtered, [4, 12, 12, 15])      // "deforestation" of savana to mosaic rather than grassland
