...
var stablePixels = ee.Image('users/dh-conciani/collection7/0_sentinel/masks/cerrado_stablePixels_col7_v2')
                      .remap([3, 4, 5, 9, 11, 12, 29, 15, 19, 39, 20, 40, 41, 46, 47, 48, 21, 23, 24, 30, 25, 33, 31],
                             [3, 4, 3, 9, 11, 12, 12, 15, 19, 19, 19, 19, 19, 19, 19, 19, 21, 25, 25, 25, 25, 33, 33])
                      .rename('reference');

// Collection 7.0 - class area by region table (generated by step 2)
var regionsCollection = ee.FeatureCollection('users/dh-conciani/collection7/0_sentinel/sample/area/2016_v2');
...
var getTrainingSamples = function (feature) {
  ...
  var training = referenceMap.stratifiedSample(
                                {'scale': 30,
                                 ...
                                 'geometries': true,
                                 'classValues': classes,
                                 'classPoints': [n_forest, n_savanna, n_forestry, n_wetland, n_grassland, n_pasture,
...
print('forestry', samplePoints.filterMetadata('reference', 'equals', 9).size());
